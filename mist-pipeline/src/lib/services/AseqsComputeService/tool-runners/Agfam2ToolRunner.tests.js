...
// Other
/**
 * This test leverages the same test hmm database as used by the Pfam30ToolRunner. Such a database
 * does not actually reflect the Agfam HMM database (in fact it is a subset of the Pfam30 database);
